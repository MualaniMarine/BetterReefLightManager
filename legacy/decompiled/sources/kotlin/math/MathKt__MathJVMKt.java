...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    private static final double m553ln(double d) {
        return Math.log(d);
    }
    ...
    /* JADX INFO: renamed from: ln */
    private static final float m554ln(float f) {
