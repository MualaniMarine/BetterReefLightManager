...
final class ContinuationMigration<T> implements Continuation<T> {
    ...
    public void resumeWith(Object result) {
        if (Result.m576isSuccessimpl(result)) {
            this.continuation.resume(result);
        }
        Throwable thM572exceptionOrNullimpl = Result.m572exceptionOrNullimpl(result);
        if (thM572exceptionOrNullimpl != null) {
            this.continuation.resumeWithException(thM572exceptionOrNullimpl);
        }
    }
}
