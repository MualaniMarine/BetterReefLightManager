...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    public static /* synthetic */ int binarySearchBy$default(List binarySearchBy, Comparable comparable, int i, int i2, Function1 selector, int i3, Object obj) {
        ...
        return CollectionsKt.binarySearch(binarySearchBy, i, i2, new C06921(selector, comparable));
    }

    /* JADX INFO: Add missing generic type declarations: [T] */
    /* JADX INFO: renamed from: kotlin.collections.CollectionsKt__CollectionsKt$binarySearchBy$1 */
    /* JADX INFO: compiled from: Collections.kt */
    @Metadata(m533bv = {1, 0, 3}, m534d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000f\n\u0002\b\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u000e\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\u0006\u0010\u0005\u001a\u0002H\u0002H\n¢\u0006\u0004\b\u0006\u0010\u0007"}, m535d2 = {"<anonymous>", "", "T", "K", "", "it", "invoke", "(Ljava/lang/Object;)I"}, m536k = 3, m537mv = {1, 1, 16})
    public static final class C06921<T> extends Lambda implements Function1<T, Integer> {
        final /* synthetic */ Comparable $key;
        final /* synthetic */ Function1 $selector;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C06921(Function1 function1, Comparable comparable) {
            super(1);
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(List<? extends T> binarySearchBy, K k, int i, int i2, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkParameterIsNotNull(binarySearchBy, "$this$binarySearchBy");
        Intrinsics.checkParameterIsNotNull(selector, "selector");
        return CollectionsKt.binarySearch(binarySearchBy, i, i2, new C06921(selector, k));
    }
