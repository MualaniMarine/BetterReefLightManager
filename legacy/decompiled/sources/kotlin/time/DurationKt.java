...
public final class DurationKt {
    ...
    private static final double m1567timesmvk6XK0(int i, double d) {
        return Duration.m1549timesimpl(d, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m1566timeskIfJnKk(double d, double d2) {
        return Duration.m1548timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m1522constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
