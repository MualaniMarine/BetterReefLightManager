...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0015R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C0015R.styleable.AlertDialog, C0015R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = typedArrayObtainStyledAttributes.getResourceId(C0015R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = typedArrayObtainStyledAttributes.getResourceId(C0015R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = typedArrayObtainStyledAttributes.getResourceId(C0015R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0015R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0015R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0015R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = typedArrayObtainStyledAttributes.getBoolean(C0015R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0015R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setupView() {
        ...
        View viewFindViewById3 = this.mWindow.findViewById(C0015R.id.parentPanel);
        View viewFindViewById4 = viewFindViewById3.findViewById(C0015R.id.topPanel);
        View viewFindViewById5 = viewFindViewById3.findViewById(C0015R.id.contentPanel);
        View viewFindViewById6 = viewFindViewById3.findViewById(C0015R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById3.findViewById(C0015R.id.customPanel);
        setupCustomContent(viewGroup);
        View viewFindViewById7 = viewGroup.findViewById(C0015R.id.topPanel);
        View viewFindViewById8 = viewGroup.findViewById(C0015R.id.contentPanel);
        View viewFindViewById9 = viewGroup.findViewById(C0015R.id.buttonPanel);
        ...
        if (!z3 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(C0015R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2 != 0) {
            ...
            View viewFindViewById10 = (this.mMessage == null && this.mListView == null) ? null : viewGroupResolvePanel.findViewById(C0015R.id.titleDividerNoCustom);
            if (viewFindViewById10 != null) {
                viewFindViewById10.setVisibility(0);
            }
        } else if (viewGroupResolvePanel2 != null && (viewFindViewById = viewGroupResolvePanel2.findViewById(C0015R.id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View viewFindViewById = this.mWindow.findViewById(C0015R.id.scrollIndicatorUp);
        final View viewFindViewById2 = this.mWindow.findViewById(C0015R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0015R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        ...
        if ((!TextUtils.isEmpty(this.mTitle)) && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0015R.id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0015R.id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0015R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0015R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0015R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
