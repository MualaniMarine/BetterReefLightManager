...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        this.f44mX = new float[iMin];
        this.f45mY = new float[iMin];
        ...
        if (Math.abs(this.f44mX[0]) <= 1.0E-5d && Math.abs(this.f45mY[0]) <= 1.0E-5d) {
            int i3 = iMin - 1;
            if (Math.abs(this.f44mX[i3] - 1.0f) <= 1.0E-5d && Math.abs(this.f45mY[i3] - 1.0f) <= 1.0E-5d) {
                float f = 0.0f;
                int i4 = 0;
                while (i < iMin) {
