...
public class ConstraintAnchor {
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (C01121.f14x4c44d048[this.mType.ordinal()]) {
            case 1:
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor constraintAnchor) {
        ...
        switch (C01121.f14x4c44d048[this.mType.ordinal()]) {
            ...
            case 9:
                return false;
            case 2:
                int i = C01121.f14x4c44d048[constraintAnchor.getType().ordinal()];
                return i == 3 || i == 7;
            case 3:
                int i2 = C01121.f14x4c44d048[constraintAnchor.getType().ordinal()];
                return i2 == 2 || i2 == 7;
            case 4:
                int i3 = C01121.f14x4c44d048[constraintAnchor.getType().ordinal()];
                return i3 == 5 || i3 == 8;
            case 5:
                int i4 = C01121.f14x4c44d048[constraintAnchor.getType().ordinal()];
                return i4 == 4 || i4 == 8;
            case 7:
                int i5 = C01121.f14x4c44d048[constraintAnchor.getType().ordinal()];
                return i5 == 2 || i5 == 3;
            case 8:
                int i6 = C01121.f14x4c44d048[constraintAnchor.getType().ordinal()];
                return i6 == 4 || i6 == 5;
            default:
                throw new AssertionError(this.mType.name());
        }
