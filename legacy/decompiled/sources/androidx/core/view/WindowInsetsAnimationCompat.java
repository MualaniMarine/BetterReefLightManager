...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(C0117R.id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0117R.id.tag_window_insets_animation_callback, null);
                if (tag == null) {
            ...
            view.setTag(C0117R.id.tag_window_insets_animation_callback, onApplyWindowInsetsListenerCreateProxyListener);
            if (tag == null) {
        ...
        static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            return view.getTag(C0117R.id.tag_on_apply_window_listener) != null ? windowInsets : view.onApplyWindowInsets(windowInsets);
        }
        ...
        static Callback getCallback(View view) {
            Object tag = view.getTag(C0117R.id.tag_window_insets_animation_callback);
