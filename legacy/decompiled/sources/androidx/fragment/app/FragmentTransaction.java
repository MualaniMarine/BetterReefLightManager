...
public abstract class FragmentTransaction {
    ...
    void addOp(C0240Op c0240Op) {
        this.mOps.add(c0240Op);
        c0240Op.mEnterAnim = this.mEnterAnim;
        c0240Op.mExitAnim = this.mExitAnim;
        c0240Op.mPopEnterAnim = this.mPopEnterAnim;
        c0240Op.mPopExitAnim = this.mPopExitAnim;
    }
