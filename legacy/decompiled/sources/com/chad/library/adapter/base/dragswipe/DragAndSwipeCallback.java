...
public class DragAndSwipeCallback extends ItemTouchHelper.Callback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int i) {
        if (i == 2 && !isViewCreateByAdapter(viewHolder)) {
            ...
            viewHolder.itemView.setTag(C0372R.id.BaseQuickAdapter_dragging_support, true);
            ...
            viewHolder.itemView.setTag(C0372R.id.BaseQuickAdapter_swiping_support, true);
        }
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getTag(C0372R.id.BaseQuickAdapter_dragging_support) != null && ((Boolean) viewHolder.itemView.getTag(C0372R.id.BaseQuickAdapter_dragging_support)).booleanValue()) {
            BaseDraggableModule baseDraggableModule = this.mDraggableModule;
            if (baseDraggableModule != null) {
                baseDraggableModule.onItemDragEnd(viewHolder);
            }
            viewHolder.itemView.setTag(C0372R.id.BaseQuickAdapter_dragging_support, false);
        }
        if (viewHolder.itemView.getTag(C0372R.id.BaseQuickAdapter_swiping_support) == null || !((Boolean) viewHolder.itemView.getTag(C0372R.id.BaseQuickAdapter_swiping_support)).booleanValue()) {
            return;
        }
        BaseDraggableModule baseDraggableModule2 = this.mDraggableModule;
        if (baseDraggableModule2 != null) {
        ...
        viewHolder.itemView.setTag(C0372R.id.BaseQuickAdapter_swiping_support, false);
    }
