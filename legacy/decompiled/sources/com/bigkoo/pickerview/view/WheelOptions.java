...
public class WheelOptions<T> {
    ...
    public WheelOptions(View view, boolean z) {
        ...
        this.view = view;
        this.wv_option1 = (WheelView) view.findViewById(C0353R.id.options1);
        this.wv_option2 = (WheelView) view.findViewById(C0353R.id.options2);
        this.wv_option3 = (WheelView) view.findViewById(C0353R.id.options3);
    }
