...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (this.mPickerOptions.customListener == null) {
            LayoutInflater.from(context).inflate(C0353R.layout.pickerview_time, this.contentContainer);
            TextView textView = (TextView) findViewById(C0353R.id.tvTitle);
            RelativeLayout relativeLayout = (RelativeLayout) findViewById(C0353R.id.rv_topbar);
            Button button = (Button) findViewById(C0353R.id.btnSubmit);
            Button button2 = (Button) findViewById(C0353R.id.btnCancel);
            button.setTag(TAG_SUBMIT);
            button2.setTag(TAG_CANCEL);
            button.setOnClickListener(this);
            button2.setOnClickListener(this);
            button.setText(TextUtils.isEmpty(this.mPickerOptions.textContentConfirm) ? context.getResources().getString(C0353R.string.pickerview_submit) : this.mPickerOptions.textContentConfirm);
            button2.setText(TextUtils.isEmpty(this.mPickerOptions.textContentCancel) ? context.getResources().getString(C0353R.string.pickerview_cancel) : this.mPickerOptions.textContentCancel);
        ...
        LinearLayout linearLayout = (LinearLayout) findViewById(C0353R.id.timepicker);
