...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            ViewGroup viewGroup = (ViewGroup) layoutInflaterFrom.inflate(C0353R.layout.layout_basepickerview, (ViewGroup) null, false);
            this.dialogView = viewGroup;
            viewGroup.setBackgroundColor(0);
            this.contentContainer = (ViewGroup) this.dialogView.findViewById(C0353R.id.content_container);
            ...
            ViewGroup viewGroup2 = (ViewGroup) layoutInflaterFrom.inflate(C0353R.layout.layout_basepickerview, this.mPickerOptions.decorView, false);
            this.rootView = viewGroup2;
            viewGroup2.setLayoutParams(new FrameLayout.LayoutParams(-1, -1));
            if (this.mPickerOptions.outSideColor != -1) {
                this.rootView.setBackgroundColor(this.mPickerOptions.outSideColor);
            }
            ViewGroup viewGroup3 = (ViewGroup) this.rootView.findViewById(C0353R.id.content_container);
    ...
    protected BasePickerView setOutSideCancelable(boolean z) {
        ...
        if (viewGroup != null) {
            View viewFindViewById = viewGroup.findViewById(C0353R.id.outmost_container);
            if (z) {
    ...
    public void createDialog() {
        if (this.dialogView != null) {
            Dialog dialog = new Dialog(this.context, C0353R.style.custom_dialog2);
            this.mDialog = dialog;
            dialog.setCancelable(this.mPickerOptions.cancelable);
            this.mDialog.setContentView(this.dialogView);
            Window window = this.mDialog.getWindow();
            if (window != null) {
                window.setWindowAnimations(C0353R.style.picker_view_scale_anim);
