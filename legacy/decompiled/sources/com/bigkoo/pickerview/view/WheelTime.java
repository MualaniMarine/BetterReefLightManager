...
import com.bigkoo.pickerview.C0353R;
...
public class WheelTime {
    ...
    private void setLunar(int i, int i2, int i3, boolean z, int i4, int i5, int i6) {
        WheelView wheelView = (WheelView) this.view.findViewById(C0353R.id.year);
        ...
        WheelView wheelView2 = (WheelView) this.view.findViewById(C0353R.id.month);
        ...
        this.wv_day = (WheelView) this.view.findViewById(C0353R.id.day);
        ...
        WheelView wheelView3 = (WheelView) this.view.findViewById(C0353R.id.hour);
        this.wv_hours = wheelView3;
        wheelView3.setAdapter(new NumericWheelAdapter(0, 23));
        this.wv_hours.setCurrentItem(i4);
        this.wv_hours.setGravity(this.gravity);
        WheelView wheelView4 = (WheelView) this.view.findViewById(C0353R.id.min);
        ...
        WheelView wheelView5 = (WheelView) this.view.findViewById(C0353R.id.second);
    ...
    public void setLabels(String str, String str2, String str3, String str4, String str5, String str6) {
        ...
        if (str != null) {
            ...
            this.wv_year.setLabel(this.view.getContext().getString(C0353R.string.pickerview_year));
        }
        if (str2 != null) {
            this.wv_month.setLabel(str2);
        } else {
            this.wv_month.setLabel(this.view.getContext().getString(C0353R.string.pickerview_month));
        }
        if (str3 != null) {
            this.wv_day.setLabel(str3);
        } else {
            this.wv_day.setLabel(this.view.getContext().getString(C0353R.string.pickerview_day));
        }
        if (str4 != null) {
            this.wv_hours.setLabel(str4);
        } else {
            this.wv_hours.setLabel(this.view.getContext().getString(C0353R.string.pickerview_hours));
        }
        if (str5 != null) {
            this.wv_minutes.setLabel(str5);
        } else {
            this.wv_minutes.setLabel(this.view.getContext().getString(C0353R.string.pickerview_minutes));
        }
        if (str6 != null) {
            this.wv_seconds.setLabel(str6);
        } else {
            this.wv_seconds.setLabel(this.view.getContext().getString(C0353R.string.pickerview_seconds));
        }
    }
