...
public final class DialogZeroBinding implements ViewBinding {
    ...
    private DialogZeroBinding(ConstraintLayout constraintLayout, PreventRepeatButton preventRepeatButton, PreventRepeatButton preventRepeatButton2, TextView textView, TextView textView2) {
    ...
    public static DialogZeroBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static DialogZeroBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0575R.layout.dialog_zero, viewGroup, false);
        if (z) {
    ...
    public static DialogZeroBinding bind(View view) {
        ...
        if (preventRepeatButton != null) {
            ...
            if (preventRepeatButton2 != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        return new DialogZeroBinding((ConstraintLayout) view, preventRepeatButton, preventRepeatButton2, textView, textView2);
                    }
                }
            }
        }
