...
final class DecodedBitStreamParser {
    ...
    private static final char f84FS = 28;

    /* JADX INFO: renamed from: GS */
    private static final char f85GS = 29;
    ...
    private static final char f86NS = 65531;
    private static final char PAD = 65532;

    /* JADX INFO: renamed from: RS */
    private static final char f87RS = 30;
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, postCode3 + f85GS + str + f85GS + str2 + f85GS);
            } else {
                sb.insert(0, postCode3 + f85GS + str + f85GS + str2 + f85GS);
            }
        } else if (i == 4) {
