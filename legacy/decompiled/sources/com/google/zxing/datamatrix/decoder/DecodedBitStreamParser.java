...
final class DecodedBitStreamParser {
    ...
    static DecoderResult decode(byte[] bArr) throws FormatException {
        ...
        do {
            if (modeDecodeAsciiSegment == Mode.ASCII_ENCODE) {
                ...
                int i = C05211.f83xb73eb560[modeDecodeAsciiSegment.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class C05211 {
        ...
        static final /* synthetic */ int[] f83xb73eb560;
        ...
        static {
            ...
            try {
                f83xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f83xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f83xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f83xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
