    ...
    */
    ...
    public long nextLong() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            String strNextQuotedValue = nextQuotedValue(iDoPeek == 8 ? '\'' : Typography.quote);
    ...
    */
    ...
    public int nextInt() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            this.peekedString = strNextQuotedValue;
            try {
                int i2 = Integer.parseInt(strNextQuotedValue);
                this.peeked = 0;
                return i2;
            } catch (NumberFormatException unused) {
            }
