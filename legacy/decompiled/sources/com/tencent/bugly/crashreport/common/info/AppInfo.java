...
public class AppInfo {
    ...
    private static ActivityManager f198a;
    ...
    /* JADX INFO: renamed from: a */
    public static String m56a(Context context) {
        if (context == null) {
            return null;
        }
        try {
    ...
    public static PackageInfo m59b(Context context) {
        try {
            return context.getPackageManager().getPackageInfo(m56a(context), 0);
        } catch (Throwable th) {
            if (C0657x.m462a(th)) {
                return null;
            }
    ...
    public static Map<String, String> m61d(Context context) {
        if (context == null) {
            return null;
        }
        try {
    ...
    /* JADX INFO: renamed from: a */
    public static List<String> m57a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
        try {
    ...
    public static boolean m62e(Context context) {
        if (context == null) {
            return false;
        }
        if (f198a == null) {
            f198a = (ActivityManager) context.getSystemService("activity");
        }
        try {
            ActivityManager.MemoryInfo memoryInfo = new ActivityManager.MemoryInfo();
            f198a.getMemoryInfo(memoryInfo);
            if (!memoryInfo.lowMemory) {
                return false;
            }
            C0657x.m466c("Memory is low.", new Object[0]);
            return true;
        } catch (Throwable th) {
            if (!C0657x.m462a(th)) {
                th.printStackTrace();
