...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void computeAxis(float f, float f2, boolean z) {
        ...
        if (this.mViewPortHandler.contentHeight() > 10.0f && !this.mViewPortHandler.isFullyZoomedOutX()) {
            ...
            if (!z) {
                f3 = (float) valuesByTouchPoint.f74x;
                d = valuesByTouchPoint2.f74x;
            } else {
                f3 = (float) valuesByTouchPoint2.f74x;
                d = valuesByTouchPoint.f74x;
            }
    ...
    protected void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f74x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f74x) - 1.0f, this.mViewPortHandler.contentBottom());
