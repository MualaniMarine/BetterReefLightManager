...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    protected void drawDataSet(Canvas canvas, ILineDataSet iLineDataSet) {
        ...
        int i = C04391.$SwitchMap$com$github$mikephil$charting$data$LineDataSet$Mode[iLineDataSet.getMode().ordinal()];
        if (i == 3) {
                    ...
                    while (i4 < fArrGenerateTransformedValuesLine.length) {
                        ...
                        if (this.mViewPortHandler.isInBoundsLeft(f3) && this.mViewPortHandler.isInBoundsY(f4)) {
                            ...
                            if (entryForIndex.getIcon() != null && iLineDataSet.isDrawIconsEnabled()) {
                                ...
                                Utils.drawImage(canvas, icon, (int) (f2 + mPPointF.f76x), (int) (f + mPPointF.f77y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                            }
                        } else {
                            i = i4;
                            mPPointF = mPPointF2;
        ...
        while (i < dataSets.size()) {
            ...
            if (iLineDataSet.isVisible() && iLineDataSet.isDrawCirclesEnabled() && iLineDataSet.getEntryCount() != 0) {
                ...
                if (this.mImageCaches.containsKey(iLineDataSet)) {
                    ...
                    DataSetImageCache dataSetImageCache2 = new DataSetImageCache(this, c04391);
        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iLineDataSet != null && iLineDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(entryForXValue, iLineDataSet)) {
                    ...
                    drawHighlightLines(canvas, (float) pixelForValues.f74x, (float) pixelForValues.f75y, iLineDataSet);
                }
            }
        }
    }
    ...
    private class DataSetImageCache {
        ...
        /* synthetic */ DataSetImageCache(LineChartRenderer lineChartRenderer, C04391 c04391) {
            this();
        }
