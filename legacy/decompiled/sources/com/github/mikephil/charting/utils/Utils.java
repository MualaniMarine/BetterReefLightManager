...
public abstract class Utils {
    ...
    private static final int[] POW_10 = {1, 10, 100, 1000, 10000, BuglyStrategy.C0583a.MAX_USERDATA_VALUE_LENGTH, 1000000, 10000000, 100000000, 1000000000};
    ...
    public static void drawImage(Canvas canvas, Drawable drawable, int i, int i2, int i3, int i4) {
        ...
        mPPointF.f76x = i - (i3 / 2);
        mPPointF.f77y = i2 - (i4 / 2);
        ...
        canvas.translate(mPPointF.f76x, mPPointF.f77y);
    ...
    public static void drawXAxisValue(Canvas canvas, String str, float f, float f2, Paint paint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (mPPointF.f76x != 0.5f || mPPointF.f77y != 0.5f) {
                FSize sizeOfRotatedRectangleByDegrees = getSizeOfRotatedRectangleByDegrees(mDrawTextRectBuffer.width(), fontMetrics, f3);
                f -= sizeOfRotatedRectangleByDegrees.width * (mPPointF.f76x - 0.5f);
                f2 -= sizeOfRotatedRectangleByDegrees.height * (mPPointF.f77y - 0.5f);
            ...
            if (mPPointF.f76x != 0.0f || mPPointF.f77y != 0.0f) {
                fWidth -= mDrawTextRectBuffer.width() * mPPointF.f76x;
                f4 -= fontMetrics * mPPointF.f77y;
            }
    ...
    public static void drawMultilineText(Canvas canvas, StaticLayout staticLayout, float f, float f2, TextPaint textPaint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (mPPointF.f76x != 0.0f || mPPointF.f77y != 0.0f) {
                f4 -= width * mPPointF.f76x;
                f5 -= lineCount * mPPointF.f77y;
            }
            canvas.save();
