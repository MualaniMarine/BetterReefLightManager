...
public class Highlight {
    ...
    public Highlight(float f, float f2, int i) {
        this.f63mX = Float.NaN;
        this.f64mY = Float.NaN;
        this.mDataIndex = -1;
        this.mStackIndex = -1;
        this.f63mX = f;
        this.f64mY = f2;
    ...
    public boolean equalTo(Highlight highlight) {
        return highlight != null && this.mDataSetIndex == highlight.mDataSetIndex && this.f63mX == highlight.f63mX && this.mStackIndex == highlight.mStackIndex && this.mDataIndex == highlight.mDataIndex;
    }

    public String toString() {
        return "Highlight, x: " + this.f63mX + ", y: " + this.f64mY + ", dataSetIndex: " + this.mDataSetIndex + ", stackIndex (only stacked barentry): " + this.mStackIndex;
    }
}
