...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    protected void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.mNoDataText)) {
                ...
                canvas.drawText(this.mNoDataText, center.f76x, center.f77y, this.mInfoPaint);
                return;
            }
            return;
        }
    ...
    protected void drawDescription(Canvas canvas) {
        ...
        if (position == null) {
            ...
            float f = position.f76x;
            height = position.f77y;
            width = f;
        }
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        int i2 = C04312.$SwitchMap$android$graphics$Bitmap$CompressFormat[compressFormat.ordinal()];
