    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (!this.mGestureDetector.onTouchEvent(motionEvent) && ((PieRadarChartBase) this.mChart).isRotationEnabled()) {
            ...
            if (action == 0) {
                ...
                this.mTouchStartPoint.f76x = x;
                this.mTouchStartPoint.f77y = y;
            } else if (action == 1) {
                if (((PieRadarChartBase) this.mChart).isDragDecelerationEnabled()) {
                    stopDeceleration();
                    sampleVelocity(x, y);
                ...
                if (this.mTouchMode == 0 && distance(x, this.mTouchStartPoint.f76x, y, this.mTouchStartPoint.f77y) > Utils.convertDpToPixel(8.0f)) {
