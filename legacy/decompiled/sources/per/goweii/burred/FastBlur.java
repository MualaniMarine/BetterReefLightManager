...
public final class FastBlur implements IBlur {
    private static FastBlur INSTANCE;
    ...
    public Bitmap process(Bitmap bitmap, float f, float f2, boolean z, boolean z2) {
        ...
        if (f2 == 1.0f) {
            Bitmap bitmapBlur = blur(bitmap, i);
            if (z2) {
                bitmap.recycle();
            }
            return bitmapBlur;
        ...
        Bitmap bitmapBlur2 = blur(bitmapScaleBitmap2, i);
        bitmapScaleBitmap2.recycle();
        if (!z) {
            return bitmapBlur2;
        }
        Bitmap bitmapScaleBitmap3 = BitmapProcessor.get().scaleBitmap(bitmapBlur2, width, height);
        bitmapBlur2.recycle();
