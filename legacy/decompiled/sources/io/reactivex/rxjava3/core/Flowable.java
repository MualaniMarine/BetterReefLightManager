...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public static <T> Flowable<T> fromObservable(ObservableSource<T> source, BackpressureStrategy strategy) {
        ...
        int i = C06611.$SwitchMap$io$reactivex$rxjava3$core$BackpressureStrategy[strategy.ordinal()];
        if (i == 1) {
    ...
    public final <R> R m527to(FlowableConverter<T, ? extends R> flowableConverter) {
    ...
    public static <T> Flowable<T> fromOptional(Optional<T> optional) {
        ...
        return (Flowable) optional.map(new java.util.function.Function() { // from class: io.reactivex.rxjava3.core.-$$Lambda$YbhinZxXO4ntYVLabnxn6Es0tdg
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return Flowable.just(obj);
            }
        }).orElseGet(new java.util.function.Supplier() { // from class: io.reactivex.rxjava3.core.-$$Lambda$iJnPngi1W8r_m2N9maUpQJSCPQM
