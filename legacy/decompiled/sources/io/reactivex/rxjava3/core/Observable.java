...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final <R> R m529to(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy strategy) {
        ...
        int i = C06621.$SwitchMap$io$reactivex$rxjava3$core$BackpressureStrategy[strategy.ordinal()];
        if (i == 1) {
    ...
    public static <T> Observable<T> fromOptional(Optional<T> optional) {
        ...
        return (Observable) optional.map(new java.util.function.Function() { // from class: io.reactivex.rxjava3.core.-$$Lambda$ACMvIXc4Di-lyJlVffPQWDhpa08
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return Observable.just(obj);
            }
        }).orElseGet(new java.util.function.Supplier() { // from class: io.reactivex.rxjava3.core.-$$Lambda$K-H45pBRMoej3rgoQqtSjW5R8l4
