...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public final <R> R m528to(MaybeConverter<T, ? extends R> maybeConverter) {
    ...
    public static <T> Maybe<T> fromOptional(Optional<T> optional) {
        ...
        return (Maybe) optional.map(new java.util.function.Function() { // from class: io.reactivex.rxjava3.core.-$$Lambda$2F_0PL0U2sjObY6vmNHRV_X8jJA
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return Maybe.just(obj);
            }
        }).orElseGet(new java.util.function.Supplier() { // from class: io.reactivex.rxjava3.core.-$$Lambda$xdX11GqNOwAcsyGUAYvJ0EiGgPE
