...
public final class FlowableDelay<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class DelaySubscriber<T> implements FlowableSubscriber<T>, Subscription {
        ...
        public void onNext(final T t) {
            this.f810w.schedule(new OnNext(t), this.delay, this.unit);
        }

        @Override // org.reactivestreams.Subscriber
        public void onError(final Throwable t) {
            this.f810w.schedule(new OnError(t), this.delayError ? this.delay : 0L, this.unit);
        }

        @Override // org.reactivestreams.Subscriber
        public void onComplete() {
            this.f810w.schedule(new OnComplete(), this.delay, this.unit);
        }
        ...
        final class OnNext implements Runnable {
            ...
            public void run() {
                DelaySubscriber.this.downstream.onNext(this.f812t);
            }
        }
        ...
        final class OnError implements Runnable {
            ...
            public void run() {
                try {
                    DelaySubscriber.this.downstream.onError(this.f811t);
                } finally {
                    DelaySubscriber.this.f810w.dispose();
                }
            }
        }
