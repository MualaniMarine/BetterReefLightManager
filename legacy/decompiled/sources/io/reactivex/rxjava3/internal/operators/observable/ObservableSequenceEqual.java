    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f846v1 == null) {
                    this.f846v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f846v1 == null;
                if (this.f847v2 == null) {
                    this.f847v2 = spscLinkedArrayQueue2.poll();
                }
                boolean z4 = this.f847v2 == null;
                if (z && z2 && z3 && z4) {
                ...
                if (!z3 && !z4) {
                    try {
                        if (!this.comparer.test(this.f846v1, this.f847v2)) {
                            cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                            this.downstream.onNext(false);
                            this.downstream.onComplete();
                            return;
