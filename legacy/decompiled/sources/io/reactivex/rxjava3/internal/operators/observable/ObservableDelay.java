...
public final class ObservableDelay<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class DelayObserver<T> implements Observer<T>, Disposable {
        ...
        public void onNext(final T t) {
            this.f838w.schedule(new OnNext(t), this.delay, this.unit);
        }

        @Override // io.reactivex.rxjava3.core.Observer
        public void onError(final Throwable t) {
            this.f838w.schedule(new OnError(t), this.delayError ? this.delay : 0L, this.unit);
        }

        @Override // io.reactivex.rxjava3.core.Observer
        public void onComplete() {
            this.f838w.schedule(new OnComplete(), this.delay, this.unit);
        }
        ...
        public boolean isDisposed() {
            return this.f838w.isDisposed();
        }

        final class OnNext implements Runnable {

            /* JADX INFO: renamed from: t */
            private final T f839t;
            ...
            public void run() {
                DelayObserver.this.downstream.onNext(this.f839t);
            }
        }
        ...
        final class OnError implements Runnable {
            ...
            public void run() {
                try {
                    ...
                    DelayObserver.this.f838w.dispose();
                }
            }
        }
