...
public final class CompletableConcatIterable extends Completable {
    ...
    public void subscribeActual(CompletableObserver observer) {
        try {
            ...
            observer.onSubscribe(concatInnerObserver.f803sd);
    ...
    static final class ConcatInnerObserver extends AtomicInteger implements CompletableObserver {
        ...
        final SequentialDisposable f803sd = new SequentialDisposable();
        ...
        void next() {
            if (!this.f803sd.isDisposed() && getAndIncrement() == 0) {
                Iterator<? extends CompletableSource> it = this.sources;
                while (!this.f803sd.isDisposed()) {
                    try {
                        if (!it.hasNext()) {
