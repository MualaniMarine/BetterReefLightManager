    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f848v1 == null) {
                    this.f848v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f848v1 == null;
                if (this.f849v2 == null) {
                    this.f849v2 = spscLinkedArrayQueue2.poll();
                }
                boolean z4 = this.f849v2 == null;
                if (z && z2 && z3 && z4) {
                ...
                if (!z3 && !z4) {
                    try {
                        if (!this.comparer.test(this.f848v1, this.f849v2)) {
                            cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                            this.downstream.onSuccess(false);
                            return;
                        } else {
