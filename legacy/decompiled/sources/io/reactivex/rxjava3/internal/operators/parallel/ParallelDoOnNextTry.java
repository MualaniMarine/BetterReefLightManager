        ...
        public boolean tryOnNext(T t) {
            ...
            do {
                try {
                    ...
                    try {
                        j++;
                        i = C06681.$SwitchMap$io$reactivex$rxjava3$parallel$ParallelFailureHandling[((ParallelFailureHandling) Objects.requireNonNull(this.errorHandler.apply(Long.valueOf(j), th), "The errorHandler returned a null ParallelFailureHandling")).ordinal()];
                    } catch (Throwable th2) {
